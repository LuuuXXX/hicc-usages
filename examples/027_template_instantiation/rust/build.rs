// 自动生成：hicc_usage_template_instantiation build.rs
...
fn main() {
    ...
    let libname = "template_instantiation";
    ...
    build.rust_file("src/lib.rs").compile("hicc_usage_template_instantiation_adapter");
