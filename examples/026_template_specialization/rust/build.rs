// 自动生成：hicc_usage_template_specialization build.rs
...
fn main() {
    ...
    let libname = "template_specialization";
    ...
    build.rust_file("src/lib.rs").compile("hicc_usage_template_specialization_adapter");
