// 自动生成：hicc_usage_inheritance_multiple build.rs
...
fn main() {
    ...
    let libname = "inheritance_multiple";
    ...
    build.rust_file("src/lib.rs").compile("hicc_usage_inheritance_multiple_adapter");
